...
export type MultiValueProps = any
...
export type MultiValueRemoveProps  =  any
export class MultiValueRemove extends React.Component<MultiValueRemoveProps> {
  render() {
    const { children, innerProps } = this.props;
    return <div {...innerProps}>{children || <div>+</div>}</div>;
  }
}

class MultiValue extends React.Component<MultiValueProps> {
  static defaultProps = {
